...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  List<Widget> getTabs(UserModel? user) {
    ...
    if (user!.userRole == "admin") tabs.add(CustomTab(icon: FontAwesomeIcons.plusCircle, size: 20, name: "Management"));
  ...
  List<Widget> getTabbarContent(UserModel? user) {
    ...
    if (user!.userRole == "admin") tabContent.add(ManagementTab());
  ...
  void initializeTabController(UserModel? user, int initialIndex) {
    if (firstRender) {
      ...
      _tabController = TabController(
        ...
        length: user!.userRole == "admin" ? 3 : 2,
      );
    }
  }
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Transform(
                              ...
                              child: Container(
                                height: MediaQuery.of(context).orientation == Orientation.portrait ? MediaQuery.of(context).size.height * 0.04 : 40,
                                width: MediaQuery.of(context).orientation == Orientation.portrait ? MediaQuery.of(context).size.height * 0.04 : 40,
                                child: Image.asset(
